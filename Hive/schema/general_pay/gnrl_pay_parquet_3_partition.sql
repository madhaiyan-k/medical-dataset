...
create table gnrl_pay_parquet_partition_quartely(
Change_Type string, 
...
Payment_Day int) partitioned by (Payment_Year string, Payment_Month int) stored as parquet;




insert overwrite table gnrl_pay_parquet_partition_quartely partition(Payment_Year, Payment_Month) 
select 
Change_Type, 
...
MONTH(Date_of_Payment)%3 from gnrl_pay_text;
