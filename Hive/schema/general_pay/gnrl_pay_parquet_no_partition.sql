...
create table gnrl_pay_without_partition_parquet(
Change_Type string, 
...
Payment_Year int,
Recipient_Country string) stored as parquet;




insert overwrite table gnrl_pay_without_partition_parquet
select 
Change_Type, 
...
Recipient_Zip_Code,
YEAR(Date_of_Payment), Recipient_Country from gnrl_pay_text;
