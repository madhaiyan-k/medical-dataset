...
create table gnrl_pay_parquet_partition_12(
Change_Type string, 
...
Recipient_Country string) partitioned by (Payment_Year string, Payment_Month int) stored as parquet;


insert overwrite table gnrl_pay_parquet_partition_12 partition(Payment_Year, Payment_Month) 
select 
Change_Type, 
