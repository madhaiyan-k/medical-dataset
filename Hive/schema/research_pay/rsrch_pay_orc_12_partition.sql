...
create table IF NOT EXISTS rsrch_pay_orc_partition_12(
Change_Type String,
...
Payment_Day int) partitioned by (Payment_Year string, Payment_Month int) stored as orc;



insert overwrite table rsrch_pay_orc_partition_12 partition(Payment_Year, Payment_Month)
select 
Change_Type,
...
MONTH(Date_of_Payment) from rsrch_pay_text;
